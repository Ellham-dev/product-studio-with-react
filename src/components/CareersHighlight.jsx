          ...
          <div className="p-[60px] border border-[#333333] ">
            ...
            <div className="">
              <div className="flex items-center justify-between border border-[#333333] px-[30px] py-5 bg-[#24242480] rounded-lg">
                ...
                <button className='px-[20px] py-3.5 bg-[#9EFF00] text-sm leading-[150%] font-medium text-[#262626] rounded-lg cursor-pointer'>Start Project</button>
              </div>
            </div>
          </div>
        </div>
...
export default CareersHighlight